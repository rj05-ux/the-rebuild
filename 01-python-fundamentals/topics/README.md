...
Personal Expense Tracker — a single-file CLI app to add, view, and delete expenses, storing them in JSON. This became the track's capstone project rather than a small standalone demo.

[View the project](./01.variables-datatypes/)

## Topic 02: Operators

Shopping Bill Calculator — practicing arithmetic and comparison operators on real cart-style data.
