...
| Number | Topic | Focus | Project | Status |
|---|---|---|---|---|
| 01 | SELECT and WHERE | Filtering rows | Student Grades | Done |
| 02 | Joins | Combining tables | Retail Sales | In Progress |
...
Update the Status column as each topic is committed: Not Started, In Progress, or Done. Fill in the Project name once a topic actually starts.
