...
Paste demo.sql into any SQL environment (MySQL Workbench, SQLite Online, or similar) and run it top to bottom. It creates the database, creates the table, inserts sample data, then runs all five queries in order.
